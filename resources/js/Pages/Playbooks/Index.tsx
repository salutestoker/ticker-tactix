    ...
    return (
        <div className="group border-main-blue/45 to-panel-deep hover:border-violet-light/70 focus-visible:ring-seafoam-green/70 relative flex min-h-[22rem] w-full flex-col overflow-hidden rounded-[14px] border bg-gradient-to-b from-[#0e1f4b] p-5 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_0_24px_rgba(55,100,245,0.16)] transition hover:-translate-y-1 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.09),0_0_30px_rgba(181,67,215,0.15)] focus-visible:ring-2 focus-visible:outline-none">
            ...
            <div className="relative flex gap-5">
                ...
                <div
                    className={`absolute right-[-16px] h-20 w-20 ${
                        playbook.price
                            ? 'top-14 sm:top-12'
                            : '-top-2 sm:top-[-25px]'
                    }`}
