...
- **PHP**: >= 8.3 for this project baseline
- **Laravel**: latest stable; Laravel 13+ preferred for fresh scaffolds
- **inertiajs/inertia-laravel**: latest compatible with the installed Laravel starter kit
- **@inertiajs/react**: Inertia 3 package line for this project baseline
- **React**: React 19 package line for this project baseline
- **TypeScript**: >= 5.0
