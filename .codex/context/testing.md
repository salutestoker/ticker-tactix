...
- Critical user flows: homepage, module index/detail, playbook index/detail, Discord login redirect/callback, admin CRUD for Modules, Playbooks, Markets, and Trader Types.
- API/endpoints to verify: public routes, admin routes, auth routes, taxonomy selects, icon selector forms, and catalog CTA rendering.
